  ...
  return (
    <>
      <div className="w-full flex flex-col mt-3 pl-[3vw] pt-10 max-md:pt-0 max-md:mt-0">
        <h2 className="text-[#515151] font-[500] text-[calc(16px+.3vw)]">
        ...
        <div className="flex flex-col gap-3 mt-5">
          ...
          >
            ...
            <p className="text-[#515151] text-[16px]">060505505</p>
          </a>
          ...
          >
            ...
            <p className="text-[#515151] text-[16px]">delivery@derjavas.am</p>
          </a>
        </div>
      </div>
    </>
