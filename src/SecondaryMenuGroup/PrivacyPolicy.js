        ...
        <>
            <div className="body mx-auto w-[60%] pt-20 [body.dark_&]:text-white ">
                ...
                <p class="mt-5"> Thank you for choosing to be part of our community <strong>(“Company”, “we”, “us”, or
                    ...
                    your personal information, please contact us at <a href="mailto:info@bonee.net">info@bonee.net</a>.
                </p>
                <p class="mt-5">When you visit our website www.bonee.net, and use our services, you trust us with your personal
                    information. We take your privacy very seriously. In this privacy notice, we describe our privacy
                    policy. We seek to explain to you in the clearest way possible what information we collect,
                    ...
                    you do not agree with, please discontinue use of our Sites and our services.
                </p>
                <p class="mt-5">This privacy policy applies to all information collected through our website and/or any related
                ...
                <p class="mb-10"><strong>
                    ...
                    sharing your personal information with us.</strong>
                </p>
                <p class="mt-5"><strong class="heading_1">TABLE OF CONTENTS</strong></p>
                <ol class="mt-5">
                    <li><p><a href="#inf1">WHAT INFORMATION DO WE COLLECT?</a></p></li>
                    <li><p><a href="#inf2">HOW DO WE USE YOUR INFORMATION?</a></p></li>
                    <li><p><a href="#inf3">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></p></li>
                    <li><p><a href="#inf4">WHO WILL YOUR INFORMATION BE SHARED WITH? </a></p></li>
                    <li><p><a href="#inf5">DATA DELETION REQUEST </a></p></li>
                    <li><p><a href="#inf6">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES? </a></p></li>
                    <li><p><a href="#inf7">DO WE USE GOOGLE MAPS? </a></p></li>
                    <li><p><a href="#inf8">IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY? </a></p></li>
                    <li><p><a href="#inf9">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a></p></li>
                    <li><p><a href="#inf10">HOW LONG DO WE KEEP YOUR INFORMATION? </a></p></li>
                    <li><p><a href="#inf11">HOW DO WE KEEP YOUR INFORMATION SAFE? </a></p></li>
                    <li><p><a href="#inf12">DO WE COLLECT INFORMATION FROM MINORS? </a></p></li>
                    <li><p><a href="#inf13">WHAT ARE YOUR PRIVACY RIGHTS?</a></p></li>
                    <li><p><a href="#inf14">CONTROLS FOR DO-NOT-TRACK FEATURES </a></p></li>
                    <li><p><a href="#inf15">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></p></li>
                    <li><p><a href="#inf16">DO WE MAKE UPDATES TO THIS POLICY? </a></p></li>
                    <li><p><a href="#inf17">TERMS OF SERVICE </a></p></li>
                    <li><p><a href="#inf18">HOW CAN YOU CONTACT US ABOUT THIS POLICY? </a></p></li>
                </ol>

                <p id="inf1" class="mt-20"><strong class="heading_1">1. WHAT INFORMATION DO WE COLLECT?</strong></p>

                <p class="mt-5"><strong>In Short:</strong> We collect personal information that you provide to us such as name,
                    address, contact information, passwords and security data, and payment information.</p> -->

                <p class="mt-5">We collect personal information that you voluntarily provide to us when registering at the Sites
                ...
                <p class="mt-5"><strong>Credentials.</strong> We collect passwords, password hints, and similar
                    security information used for authentication and account access.</p>

                <p class="mt-5"><strong>Payment Data.</strong> Bonee Systems does not collect or save any payment data.
                    In case of online payment processing the whole payment information including the sensitive
                    data is being collected and stored by the payment processor. The payment processors varies
                    depending on the regions and payment methods.</p>

                <p class="mt-5">All personal information that you provide to us must be true, complete and accurate,
                    and you must notify us of any changes to such personal information.
                </p>

                <p class="mt-20"><strong>Information automatically collected</strong></p>

                <p class="mt-5"><strong>In Short:</strong> Some information – such as IP address and/or browser and device
                    characteristics – is collected automatically when you visit our Sites.</p>

                <p class="mt-5">Like many businesses, we also collect information through cookies and similar technologies.</p>

                <p class="mt-20"><strong> Information collected from other sources</strong></p>

                <p class="mt-5"><strong>In Short: </strong> We may collect limited data from public databases, marketing partners,
                    and other outside sources.</p>

                <p class="mt-5">We may obtain information about you from other sources, such as public databases, joint marketing
                    partners, as well as from other third parties. Examples of the information we receive from other
                    sources include: social media profile information; marketing leads and search results and links,
                    including paid listings (such as sponsored links).</p>

                <p id="inf2" class="mt-20"><strong class="heading_1"> 2. HOW DO WE USE YOUR INFORMATION?</strong></p>

                <p class="mt-5"><strong>In Short:</strong> We process your information for purposes based on legitimate business
                    interests,
                    the fulfillment of our contract with you, compliance with our legal obligations, and/or your
                    consent.</p>

                <p class="mt-5">We use personal information collected via our Sites for a variety of business purposes described
                    below.
                ...
                <p class="mt-5">We use the information we collect or receive:</p>

                <ul type="square" class="mt-5">
                    <li>
                        <p class="mt-5"><strong>To facilitate account creation and logon process. </strong> If you choose to link
                            your
                    ...
                    <li>
                        <p class="mt-5"><strong>To send you marketing and promotional communications.</strong> We and/or our third
                            party
                            marketing partners may use the personal information you send to us for our marketing
                            purposes,
                            if this is in accordance with your marketing preferences. You can opt-out of our marketing
                            emails
                    ...
                    <li>
                        <p class="mt-5"><strong>To send administrative information to you.</strong>We may use your personal
                            information to
                    ...
                    <li>
                        <p class="mt-5"><strong>Fulfill and manage your orders.</strong> We may use your information to fulfill and
                            manage
                    ...
                    <li>
                        <p class="mt-5"><strong>To post testimonials.</strong>We post testimonials on our Sites that may contain
                            ...
                            us at <a href="mailto:info@bonee.net">info@bonee.net</a> and be sure to include your name,
                            testimonial location, and contact information.</p>
                    </li>

                    <li>
                        <p class="mt-5">
                            <stromg>Deliver targeted advertising to you.</stromg>
                    ...
                    <li>
                        <p class="mt-5"><strong>Request Feedback.</strong> We may use your information to request feedback and to
                            contact you about your use of our Sites.
                        </p>
                    </li>

                    <li>
                        <p class="mt-5"><strong>To protect our Sites. </strong> We may use your information as part of our efforts to
                            keep our Sites safe and secure (for example, for fraud monitoring and prevention).
                        </p>
                    </li>

                    <li>
                        <p class="mt-5"><strong> To enforce our terms, conditions and policies. </strong></p>
                    </li>

                    <li>
                        <p class="mt-5"><strong>To respond to legal requests and prevent harm.</strong> If we receive a subpoena or
                            other
                            legal request, we may need to inspect the data we hold to determine how to respond.</p>
                    </li>

                    <li>
                        <p class="mt-5"><strong>For other Business Purposes.</strong> We may use your information for other Business
                            Purposes, such as data analysis, identifying usage trends, determining the effectiveness
                            of our promotional campaigns and to evaluate and improve our Sites, products, services,
                            marketing and your experience.
                        </p>
                    </li>
                </ul>

                <p id="inf3" class="mt-20"><strong class="heading_1"> 3. WILL YOUR INFORMATION BE SHARED WITH
                    ANYONE?</strong></p>

                <p class="mt-5"><strong>In Short: </strong> We only share information with your consent, to comply with laws, to
                    protect your
                    rights, or to fulfill business obligations.
                </p>

                <p class="mt-5">We may process or share data based on the following legal basis:</p>
                ...
                <ul type="square">
                    <li>
                        <p><strong>Vendors, Consultants and Other Third-Party Service Providers.</strong> We may share
                            your data with third
                            party vendors, service providers, contractors or agents who perform services for us or on
                            our behalf and require
                            access to such information to do that work. Examples include: payment processing, data
                            analysis, email delivery,
                            hosting services, customer service and marketing efforts. We may allow selected third
                            parties to use tracking
                            ...
                            content and better understand online activity. Unless described in this Policy, we do not
                            share, sell, rent or
                ...
                <p id="inf4" class="mt-60"><strong class="heading_1"> 4. WHO WILL YOUR INFORMATION BE SHARED
                    WITH?</strong></p>
                ...
                <p>We only share and disclose your information with the following third parties. We have categorized
                    each
                    party so that you may be easily understand the purpose of our data collection and processing
                    practices.
                    If we have processed your data based on your consent and you wish to revoke your consent, please
                    contact us.</p>

                <p><strong>- Advertising, Direct Marketing, and Lead Generation</strong></p>
                <p><strong>- Functionality and Infrastructure Optimization</strong></p>
                <p><strong>- Social Media Sharing and Advertising </strong></p>
                <p><strong>- Invoicing &amp; Billing</strong></p>

                <p id="inf5" class="mt-60"><strong class="heading_1">5. DATA DELETION REQUEST</strong></p>

                <p>For any data deletion, please send a data deletion request via email address support@bonee.net with
                    a subject "Data Deletion Request". Please include as much information as possible regarding which
                    data you would like to be deleted. If you would like to disconnect your Facebook page, kindly send a
                    data deletion request via email address support@bonee.net with a subject "Facebook Data Deletion
                    Request"
                    and provide your Facebook account URL. The request will be escalated to the proper team for
                    evaluation and processing.
                    We will reach out every step of the way to keep you updated on the deletion progress.
                    You can also delete your account from your dashboard by clicking on "Delete my account" button</p>

                <p id="inf6" class="mt-60"><strong class="heading_1">6. DO WE USE COOKIES AND OTHER TRACKING
                ...
                <p id="inf7" class="mt-60"><strong class="heading_1">7. DO WE USE GOOGLE MAPS? </strong></p>

                <p><strong>In Short: </strong> Yes, we use Google Maps for the purpose of providing better service.</p>

                <p>This website, mobile application uses Google Maps APIs. You may find the Google Maps APIs Terms of
                    Service <a href="https://developers.google.com/maps/terms-20180207" target="_blank">here.</a>
                    To better understand Google’s Privacy Policy, please refer to this <a
                        href="https://policies.google.com/privacy?hl=en-US" target="_blank">link</a>.
                </p>

                <p>By using our Maps API Implementation, you agree to be bound by Google’s Terms of Service.
                    By using our implementation of the Google Maps APIs, you agree to allow us to gain access
                    to information about you including personally identifiable information (such as usernames) and
                    non-personally identifiable information (such as location).
                </p>

                <p>For a full list of what we use information for, please see the previous section titled <strong>"HOW
                    DO WE USE
                    YOUR INFORMATION?" and “WILL YOUR INFORMATION BE SHARED WITH ANYONE?”</strong>
                </p>

                <p>The Maps APIs that we use store and access cookies and other information on your devices.
                    If you are a user currently in the European Union, please take a look at our EU User Consent Policy.
                </p>

                <p id="inf8" class="mt-60"><strong class="heading_1">8. IS YOUR INFORMATION TRANSFERRED
                    INTERNATIONALLY?</strong></p>

                <p><strong>In Short: </strong>We may transfer, store, and process your information in countries other
                    than your own.</p>

                <p>Our servers are located in Microsoft Azure. If you are accessing our Sites from outside your country,
                    please be aware that your information may be transferred to, stored, and processed by us in our
                    facilities
                    and by those third parties with whom we may share your personal information (see <strong>"WILL YOUR
                        INFORMATION BE
                        SHARED WITH ANYONE?</strong> " above), in and other countries.
                </p>

                <p id="inf9" class="mt-60"><strong class="heading_1">9. WHAT IS OUR STANCE ON THIRD-PARTY
                    WEBSITES?</strong></p>

                <p><strong>In Short:</strong>We are not responsible for the safety of any information that you share
                    with
                    third-party providers who advertise, but are not affiliated with, our websites.
                </p>

                <p>The Sites may contain advertisements from third parties that are not affiliated with us and which may
                    link to other
                    websites, online services or mobile applications. We cannot guarantee the safety and privacy of data
                    you provide
                    to any third parties. Any data collected by third parties is not covered by this privacy policy. We
                    are not
                    responsible for the content or privacy and security practices and policies of any third parties,
                    including
                    other websites, services or applications that may be linked to or from the Sites. You should review
                    the
                    policies of such third parties and contact them directly to respond to your questions.
                </p>

                <p id="inf10" class="mt-60"><strong class="heading_1">10. HOW LONG DO WE KEEP YOUR
                    INFORMATION? </strong></p>

                <p><strong>In Short:</strong>We keep your information for as long as necessary to fulfill the purposes
                    outlined
                    in this privacy policy unless otherwise required by law.</p>
                ...
                <p>When we have no ongoing legitimate business need to process your personal information, we will either
                    ...
                    stored in backup archives),
                    then we will securely store your personal information and isolate it from any further processing
                    until deletion is possible.
                </p>


                <p id="inf11" class="mt-60"><strong class="heading_1">11. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong>
                </p>
                ...
                <p>We have implemented appropriate technical and organizational security measures designed to protect
                    ...
                    information,
                    transmission of personal information to and from our Sites is at your own risk. You should only
                    access
                    the services within a secure environment.
                </p>

                <p id="inf12" class="mt-60"><strong class="heading_1">12. DO WE COLLECT INFORMATION FROM
                    MINORS?</strong></p>
                ...
                <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the
                    Sites, you represent that you are at least 18 or that you are the parent or guardian of such
                    a minor and consent to such minor dependent’s use of the Sites. If we learn that personal
                    information from users less than 18 years of age has been collected, we will deactivate the account
                    and
                    take reasonable measures to promptly delete such data from our records. If you become aware of any
                    data
                    we have collected from children under age 18, please contact us at <a
                        href="mailto:info@bonee.net">info@bonee.net</a>.
                </p>

                <p id="inf13" class="mt-60"><strong class="heading_1">13. WHAT ARE YOUR PRIVACY RIGHTS?</strong></p>

                <p><strong>In Short:</strong> In some regions, such as the European Economic Area, you have rights that
                    allow
                ...
                <p>In some regions (like the European Economic Area), you have certain rights under applicable data
                    ...
                    processing of your
                    personal information. To make such a request, please use the <strong>contact
                        details</strong> provided below. We will consider and
                ...
                <p>If you would at any time like to review or change the information in your account or terminate your
                    account,
                    you can log into your account settings and update your user account.
                </p>
                ...
                <p><strong> Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by
                    ...
                    of our Sites. To opt-out of interest-based advertising by advertisers on our Sites visit
                ...
                <p><strong> Opting out of email marketing:</strong> You can unsubscribe from our marketing email list at
                    ...
                    contact us using
                    the contact information provided or access your account settings and update preferences
                </p>


                <p id="inf14" class="mt-60"><strong class="heading_1">14. CONTROLS FOR DO-NOT-TRACK FEATURES</strong>
                </p>
                ...
                <p id="inf15" class="mt-60"><strong class="heading_1">15. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY
                    RIGHTS?</strong></p>
                ...
                <p>California Civil Code Section 1798.83, also known as the “Shine The Light” law, permits our users who
                    are California
                    residents to request and obtain from us, once a year and free of charge, information about
                    categories of personal
                    information (if any) we disclosed to third parties for direct marketing purposes and the names and
                    addresses of all
                    third parties with which we shared personal information in the immediately preceding calendar year.
                    If you are a
                    California resident and would like to make such a request, please submit your request in writing to
                    us using the
                ...
                <p>If you are under 18 years of age, reside in California, and have a registered account with the
                    Sites,
                    you have the right to request removal of unwanted data that you publicly post on the Sites.
                    ...
                    California.
                    e will make sure the data is not publicly displayed on the

                    Sites, but please be aware that the data may not be completely or comprehensively removed from our
                    systems.
                </p>
                <p id="inf16" class="mt-60"><strong class="heading_1">16. DO WE MAKE UPDATES TO THIS POLICY?</strong>
                </p>

                <p><strong>In Short: </strong> Yes, we will update this policy as necessary to stay compliant with
                    relevant laws.</p>
                ...
                <p>We may update this privacy policy from time to time. The updated version will be indicated by an
                    ...
                    changes to
                    this privacy policy, we may notify you either by prominently posting a notice of such changes or by
                    directly
                    sending you a notification. We encourage you to review this privacy policy frequently to be informed
                    of how we
                    are protecting your information.
                </p>
                <p id="inf17" class="mt-60"><strong class="heading_1">17. TERMS OF SERVICE </strong></p>
                ...
                <p>
                    By signing up for a bonee digital QR menu system or by using any Services (as defined below), you
                    are agreeing
                    to be bound by the following terms and conditions (the “Terms of Service”).
                </p>

                <p>
                    The services offered by bonee digital QR menu system under the Terms of Service include services to
                    help you sell
                    products and services to buyers, whether online (“Online Services”) by enabling you to create and
                    build your own online store,
                    digital QR menu or digital catalog. Any such services offered by bonee are referred to in these
                    Terms of Services as the “Services”.
                    You are advised to check the Terms of Service from time to time for any updates or changes that may
                    impact you.
                </p>

                <p><strong>1. Account Terms</strong></p>

                <ul type="disc">
                    <li>
                        <p>
                            To access and use the Services, you must register for a bonee account (“Account”) by
                            providing your full name, business name, phone number, a valid email address, and setup your
                            account password.
                        </p>
                    </li>
                    <li>
                        <p>
                            You acknowledge that bonee will use the email address you provide on opening an Account or
                            as updated by you from
                            time to time as the primary method for communication with you. You must monitor the primary
                            Account email address you
                            provide and your primary Account email address must be capable of both sending and receiving
                            messages.
                        </p>
                    </li>
                    <li>
                        <p>
                            You are responsible for keeping your password secure. Bonee cannot and will not be
                            responsible for any loss or damage
                            from your failure to maintain the security of your Account and password. You acknowledge
                    ...
                    <li>
                        <p>
                            You are responsible for all activity and content such as photos, images, videos, written
                            content, pricing, information in connection with your Account.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case of registration in the bonee system with invalid or fake email and non-reachable
                            phone number the service provider reserves the right to
                            block an account which seems to be suspicious due to invalid contact details mentioned
                            during registration process even if the account is in free trial period.
                        </p>
                    </li>
                </ul>

                <p><strong>2. Password guidance </strong></p>

                <ul type="disc">
                    <li>
                        <p>
                            <strong>Password Construction Requirements </strong>
                        </p>
                        <p>1. Be a minimum length of eight (8) characters on all systems</p>
                        <p>2. Include both upper- and lower-case letters </p>
                        <p>3. Include at least 1 number </p>
                        <p>4. Not be a dictionary word or proper name </p>
                        <p>5. Not be the same as the User ID </p>
                        <p>6. Not be transmitted in the clear or plaintext outside the secure location </p>
                        <p>7. Ensure passwords are only reset for authorized user </p>
                    </li>
                    <li>
                        <p>
                            <strong>Password Protection Standards </strong>
                        </p>
                        <p>1. Do not use your User ID as your password</p>
                        <p>2. All passwords are to be treated as sensitive </p>
                        <p>3. In case if the user provides a password to the support agent for assistance purposes, the
                            agent is obliged to immediately delete the user’s password and never save it for any
                            purpose </p>
                        <p>4. In case if user enters incorrect password more than 20 times at once, the system will
                            automatically block the account for security purposes. To unblock the account user should
                            contact via email </p>
                    </li>
                </ul>

                <p><strong>3. Account Activation and Billing </strong></p>
                <ul type="disc">
                    <li>
                        <p>
                            The person signing up for the Service by opening an Account will be the contracting party
                            (“Store Owner”) for the purposes of our Terms of Service
                            and will be the person who is authorized to use any corresponding Account provided to the
                            Store Owner in connection with the Service of bonee.
                        </p>
                    </li>
                    <li>
                        <p>
                            To use the bonee services you must have Internet access and a capable device (PC, Android or
                            iOS smartphone or tablet), and provide us with a Payment Method.
                            “Payment Method” means a current, valid, accepted method of payment, as may be updated from
                            time to time, and which may include payment through your account
                            with a third party. In case if you choose an autorenewal payment option, unless you cancel
                            your subscription before your billing date, you authorize us to
                            charge the subscription fee for the next billing cycle to your Payment Method.
                        </p>
                        <p>
                            In case if you choose manual renewal, you are responsible for making subscription payment on
                            time. The system will notify you about next payment date.
                        </p>
                    </li>
                    <li>
                        <p>
                            After attaching a Payment method and registering in the system, you have 7 days free trial
                            to test the system. No fee is charged during 7 days free trial.
                            You reserve the right to cancel the subscription anytime during free trial period.
                        </p>
                    </li>
                    <li>
                        <p>
                            After free trial period expiration, the account will be activated as soon as the
                            subscription fee is charged. In case if the fee is not charged for some
                            reason connected to your Payment method the account will be deactivated.
                        </p>
                    </li>
                    <li>
                        <p>
                            The subscription fee for bonee service and any other charges you may incur in connection
                            with your use of the service, such as taxes and possible transaction
                            fees, will be charged to your Payment Method on the specific billing date. The length of
                            your billing cycle will depend on the type of subscription that
                            you choose when you sign-up for the service. In some cases, your payment date may change,
                            for example if your Payment Method has not successfully settled
                            or if your paid subscription began on a day not contained in a given month.
                        </p>
                    </li>
                    <li>
                        <p>
                            We may change subscription plans from time to time; however, any price changes or changes to
                            your subscription plans will apply no earlier
                    ...
                    <li>
                        <p>
                            ...
                            bonee Support and then following the specific
                            instructions indicated to you in response.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case of subscription cancellation you can request a refund within 7 days. After 7 days
                            refund option will no longer be available.
                            Note: COVID menu subscription plan for any time period is non-refundable.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case of menu set-up service provided by bonee agents the setup fee at an amount of 100
                            USD will be deducted from the refunded amount.
                        </p>
                    </li>
                    <li>
                        <p>
                            In our free plan bonee system reserve the right to activate AdSense and Pop up ads.
                        </p>
                    </li>
                    <li>
                        <p>
                            We may cancel your account and terminate the terms of service, if the profile is empty,
                            wrong credential provided or not verified business.
                        </p>
                    </li>
                </ul>
                ...
                <ul type="disc">
                    <li>
                        <p>
                            Bonee is firmly committed to protecting the privacy of your personal information and the
                            personal information of your customers.
                            By using the Service, you acknowledge and agree that bonee collection, usage and disclosure
                            of this personal information is governed by our Privacy Policy.
                        </p>
                    </li>
                    <li>
                        <p>
                            We do guarantee the safety of your data. After account deactivation the account data will be
                            kept on our data base during 3 months.
                            After expiration of 3 months period the whole data will be removed from our data base.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case if you change your mind and want to reopen the account during 3 months’
                            time period after account deactivation you can request to reopen your account by sending an
                            email to <strong>support@bonee.net</strong>.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case of expiration of 3 months period after account deactivation the data recovery is a
                            subject of a request that could be reviewed by
                            the technical team. You can send a data recovery request via email address
                            support@bonee.net.
                        </p>
                    </li>
                    <li>
                        <p>
                            Access to your personal data will be restricted to minimum number of people who need to
                            perform actions to provide you technical
                            support and account maintenance. Bonee may share your information with third parties, under
                            a signed agreement, if so, is required
                            for third party system integration. Bonee may share your information with any third party
                            only based on your prior consent.
                        </p>
                    </li>
                </ul>
                ...
                <ul type="disc">
                    <li>
                        <p>
                            Bonee provides third party system integrations such as payment gateway integration for
                            online payments, email and SMS system integrations,
                            Google analytics and Facebook Pixel integration. Third party systems are available on
                            Marketplace section of your bonee account.
                        </p>
                    </li>
                    <li>
                        <p>
                            The relationship between you and any Third-Party Provider is strictly between you and such
                            Third-Party Provider, and bonee is not obligated to
                            intervene in any dispute arising between you and a Third-Party Provider.
                        </p>
                    </li>
                    <li>
                        <p>
                            In case of online payments, the transaction fees depend on the specific payment gateway and
                            the geographical location of your business.
                            Bonee does not charge any additional fee on online payments and all transaction fees should
                            be checked and confirmed with the payment gateway provider.
                        </p>
                    </li>
                    <li>
                        <p>
                            Any third-party system such as POS system integration that is not mentioned on Marketplace
                            section of your bonee account is a subject of
                            discussion. All integration requests can be addressed to support@bonee.net with “Integration
                            request” subject.
                        </p>
                    </li>
                </ul>
                ...
                <p id="inf18" class="mt-60"><strong class="heading_1">18. HOW CAN YOU CONTACT US ABOUT THIS
                    POLICY?</strong></p>

                <p>If you have questions or comments about this policy, you may email us at <a
                    href="mailto:info@bonee.net">info@bonee.net</a>.</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement) refers to Bonee Systems LLC, 8 The Green Ste A, Dover, Delaware 19901, USA.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to bonee, accessible from <a href="https://bonee.net"
                                                                                        rel="external nofollow noopener"
                                                                                        target="_blank">https://bonee.net</a>
                        </p>
                    </li>
                    <li>
