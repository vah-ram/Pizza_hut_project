  ...
  return (
    <>
      <div className="body mx-auto w-[60%] pt-20 [body.dark_&]:text-white ">
        ...
        <p id="inf1" class="mt-20">
          <strong class="heading_1">1. WHAT INFORMATION DO WE COLLECT?</strong>
        </p>
        <p class="mt-5">
        ...
        <p class="mt-5">
          <strong>Payment Data.</strong> Bonee Systems does not collect or save
          any payment data. In case of online payment processing the whole
          payment information including the sensitive data is being collected
          and stored by the payment processor. The payment processors varies
          depending on the regions and payment methods.
        </p>
        <p class="mt-5">
        ...
        <p id="inf2" class="mt-20">
          <strong class="heading_1"> 2. HOW DO WE USE YOUR INFORMATION?</strong>
        </p>
        <p class="mt-5">
        ...
        <ul type="square" class="mt-5">
          ...
          <li>
            <p class="mt-5">
              ...
              information as part of our efforts to keep our Sites safe and
        ...
        <p>
          <strong>- Invoicing &amp; Billing</strong>
        </p>
        <p id="inf5" class="mt-60">
          <strong class="heading_1">5. DATA DELETION REQUEST</strong>
        </p>
        <p>
          For any data deletion, please send a data deletion request via email
          address support@bonee.net with a subject "Data Deletion Request".
          Please include as much information as possible regarding which data
          you would like to be deleted. If you would like to disconnect your
          Facebook page, kindly send a data deletion request via email address
          support@bonee.net with a subject "Facebook Data Deletion Request" and
          provide your Facebook account URL. The request will be escalated to
          the proper team for evaluation and processing. We will reach out every
          step of the way to keep you updated on the deletion progress. You can
          also delete your account from your dashboard by clicking on "Delete my
          account" button
        </p>
        <p id="inf6" class="mt-60">
          <strong class="heading_1">
        ...
        <p id="inf7" class="mt-60">
          <strong class="heading_1">7. DO WE USE GOOGLE MAPS? </strong>
        </p>
        <p>
          <strong>In Short: </strong> Yes, we use Google Maps for the purpose of
          providing better service.
        </p>
        <p>
          This website, mobile application uses Google Maps APIs. You may find
          the Google Maps APIs Terms of Service{" "}
          <a
        ...
        <p>
          ...
          Maps APIs, you agree to allow us to gain access to information about
          you including personally identifiable information (such as usernames)
          and non-personally identifiable information (such as location).
        </p>
        <p>
          For a full list of what we use information for, please see the
          previous section titled{" "}
          <strong>
            "HOW DO WE USE YOUR INFORMATION?" and “WILL YOUR INFORMATION BE
            SHARED WITH ANYONE?”
          </strong>
        </p>
        <p>
        ...
        <p>
          Our servers are located in Microsoft Azure. If you are accessing our
          Sites from outside your country, please be aware that your information
        ...
        <p>
          ...
          information that you share with third-party providers who advertise,
          but are not affiliated with, our websites.
        </p>
        <p>
        ...
        <p>
          ...
          at <a href="mailto:info@bonee.net">info@bonee.net</a>.
        </p>
        <p id="inf13" class="mt-60">
          <strong class="heading_1">13. WHAT ARE YOUR PRIVACY RIGHTS?</strong>
        </p>
        <p>
        ...
        <p>
          ...
          <strong>contact details</strong> provided below. We will consider and
        ...
        <p>
          ...
          use of your account. To otherwise opt-out, you may contact us using
          the contact information provided or access your account settings and
          update preferences
        </p>
        <p id="inf14" class="mt-60">
          <strong class="heading_1">
        ...
        <p>
          ...
          with your account and a statement that you reside in California. e
        ...
        <p id="inf17" class="mt-60">
          <strong class="heading_1">17. TERMS OF SERVICE </strong>
        </p>
        <p>Last updated on: February 22, 2021</p>
        <p>
          By signing up for a bonee digital QR menu system or by using any
          Services (as defined below), you are agreeing to be bound by the
          following terms and conditions (the “Terms of Service”).
        </p>
        <p>
          The services offered by bonee digital QR menu system under the Terms
          of Service include services to help you sell products and services to
          buyers, whether online (“Online Services”) by enabling you to create
          and build your own online store, digital QR menu or digital catalog.
          Any such services offered by bonee are referred to in these Terms of
          Services as the “Services”. You are advised to check the Terms of
          Service from time to time for any updates or changes that may impact
          you.
        </p>
        <p>
        ...
        <ul type="disc">
          <li>
            <p>
              To access and use the Services, you must register for a bonee
              account (“Account”) by providing your full name, business name,
              phone number, a valid email address, and setup your account
              password.
            </p>
          </li>
          <li>
            <p>
              You acknowledge that bonee will use the email address you provide
              on opening an Account or as updated by you from time to time as
              the primary method for communication with you. You must monitor
              the primary Account email address you provide and your primary
          ...
          <li>
            <p>
              You are responsible for keeping your password secure. Bonee cannot
              and will not be responsible for any loss or damage from your
              failure to maintain the security of your Account and password. You
          ...
          <li>
            <p>
              ...
              images, videos, written content, pricing, information in
              connection with your Account.
            </p>
          </li>
          <li>
            <p>
              In case of registration in the bonee system with invalid or fake
              email and non-reachable phone number the service provider reserves
              the right to block an account which seems to be suspicious due to
              invalid contact details mentioned during registration process even
              if the account is in free trial period.
            </p>
          </li>
        </ul>
        <p>
          <strong>2. Password guidance </strong>
        </p>
        <ul type="disc">
          <li>
            <p>
            ...
            <p>
              6. Not be transmitted in the clear or plaintext outside the secure
              location{" "}
            </p>
          ...
          <li>
            ...
            <p>
              3. In case if the user provides a password to the support agent
              for assistance purposes, the agent is obliged to immediately
              delete the user’s password and never save it for any purpose{" "}
            </p>
            <p>
              4. In case if user enters incorrect password more than 20 times at
              once, the system will automatically block the account for security
              purposes. To unblock the account user should contact via email{" "}
            </p>
          </li>
        </ul>
        <p>
          <strong>3. Account Activation and Billing </strong>
        </p>
        <ul type="disc">
          <li>
            <p>
              The person signing up for the Service by opening an Account will
              be the contracting party (“Store Owner”) for the purposes of our
              Terms of Service and will be the person who is authorized to use
              any corresponding Account provided to the Store Owner in
              connection with the Service of bonee.
            </p>
          </li>
          <li>
            <p>
              To use the bonee services you must have Internet access and a
              capable device (PC, Android or iOS smartphone or tablet), and
              provide us with a Payment Method. “Payment Method” means a
              current, valid, accepted method of payment, as may be updated from
              time to time, and which may include payment through your account
              with a third party. In case if you choose an autorenewal payment
              option, unless you cancel your subscription before your billing
              date, you authorize us to charge the subscription fee for the next
              billing cycle to your Payment Method.
            </p>
            <p>
              In case if you choose manual renewal, you are responsible for
              making subscription payment on time. The system will notify you
              about next payment date.
            </p>
          </li>
          <li>
            <p>
              After attaching a Payment method and registering in the system,
              you have 7 days free trial to test the system. No fee is charged
              during 7 days free trial. You reserve the right to cancel the
              subscription anytime during free trial period.
            </p>
          </li>
          <li>
            <p>
              After free trial period expiration, the account will be activated
              as soon as the subscription fee is charged. In case if the fee is
              not charged for some reason connected to your Payment method the
              account will be deactivated.
            </p>
          </li>
          <li>
            <p>
              The subscription fee for bonee service and any other charges you
              may incur in connection with your use of the service, such as
              taxes and possible transaction fees, will be charged to your
              Payment Method on the specific billing date. The length of your
              billing cycle will depend on the type of subscription that you
              choose when you sign-up for the service. In some cases, your
              payment date may change, for example if your Payment Method has
              not successfully settled or if your paid subscription began on a
              day not contained in a given month.
            </p>
          </li>
          <li>
            <p>
              We may change subscription plans from time to time; however, any
              price changes or changes to your subscription plans will apply no
          ...
          <li>
            <p>
              ...
              any time by contacting bonee Support and then following the
              specific instructions indicated to you in response.
            </p>
          </li>
          <li>
            <p>
              In case of subscription cancellation you can request a refund
              within 7 days. After 7 days refund option will no longer be
              available. Note: COVID menu subscription plan for any time period
              is non-refundable.
            </p>
          </li>
          <li>
            <p>
              In case of menu set-up service provided by bonee agents the setup
              fee at an amount of 100 USD will be deducted from the refunded
              amount.
            </p>
          </li>
          <li>
            <p>
              In our free plan bonee system reserve the right to activate
              AdSense and Pop up ads.
            </p>
          </li>
          <li>
            <p>
              We may cancel your account and terminate the terms of service, if
              the profile is empty, wrong credential provided or not verified
              business.
            </p>
          </li>
        </ul>
        <p>
          <strong>4. Privacy &amp; Data Protection </strong>
        </p>
        <ul type="disc">
          <li>
            <p>
              Bonee is firmly committed to protecting the privacy of your
              personal information and the personal information of your
              customers. By using the Service, you acknowledge and agree that
              bonee collection, usage and disclosure of this personal
              information is governed by our Privacy Policy.
            </p>
          </li>
          <li>
            <p>
              We do guarantee the safety of your data. After account
              deactivation the account data will be kept on our data base during
              3 months. After expiration of 3 months period the whole data will
              be removed from our data base.
            </p>
          </li>
          <li>
            <p>
              In case if you change your mind and want to reopen the account
              during 3 months’ time period after account deactivation you can
              request to reopen your account by sending an email to{" "}
              <strong>support@bonee.net</strong>.
            </p>
          </li>
          <li>
            <p>
              In case of expiration of 3 months period after account
              deactivation the data recovery is a subject of a request that
              could be reviewed by the technical team. You can send a data
              recovery request via email address support@bonee.net.
            </p>
          </li>
          <li>
            <p>
              Access to your personal data will be restricted to minimum number
              of people who need to perform actions to provide you technical
              support and account maintenance. Bonee may share your information
              with third parties, under a signed agreement, if so, is required
              for third party system integration. Bonee may share your
              information with any third party only based on your prior consent.
            </p>
          </li>
        </ul>
        <p>
          <strong>5. Third-Party integrations </strong>
        </p>
        <ul type="disc">
          <li>
            <p>
              Bonee provides third party system integrations such as payment
              gateway integration for online payments, email and SMS system
              integrations, Google analytics and Facebook Pixel integration.
              Third party systems are available on Marketplace section of your
              bonee account.
            </p>
          </li>
          <li>
            <p>
              ...
              strictly between you and such Third-Party Provider, and bonee is
              not obligated to intervene in any dispute arising between you and
              a Third-Party Provider.
            </p>
          </li>
          <li>
            <p>
              In case of online payments, the transaction fees depend on the
              specific payment gateway and the geographical location of your
              business. Bonee does not charge any additional fee on online
              payments and all transaction fees should be checked and confirmed
              with the payment gateway provider.
            </p>
          </li>
          <li>
            <p>
              Any third-party system such as POS system integration that is not
              mentioned on Marketplace section of your bonee account is a
              subject of discussion. All integration requests can be addressed
              to support@bonee.net with “Integration request” subject.
            </p>
          </li>
        </ul>
        <p id="inf18" class="mt-60">
          <strong class="heading_1">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Bonee Systems
              LLC, 8 The Green Ste A, Dover, Delaware 19901, USA.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to bonee, accessible from{" "}
              <a
                href="https://bonee.net"
