  ...
  return (
    <>
      ...
      <div className="w-full px-5 py-10 max-w-7xl mx-auto [body.dark_&]:text-white">
        ...
        {/* Description */}
        <p className="mb-4">
          In 1958 brothers Frank and Dan Carney decided to open a large pizza
          restaurant in Wichita (Kansas). When one of their friends offered them
          to open a rather rare restaurant at that time, they thought that the
          idea could bring them success and borrowed $600 from their mother to
          start the business with their partner, John Bender. Carney brothers
          and John Bender rented a small building and obtained the equipment
          needed for cooking pizzas and opened the first Pizza Hut restaurant at
          503 South Bluff street in the center of Wichita. On the opening day,
          they offered free pizzas to people in order to get the interest of the
          community. The small restaurant was meant for 25 people and looked
          like a hut ... this is how the concept of "Pizza Hut" was born.
        </p>

        <p className="mb-4">
          A year later, in 1959, Pizza Hut was registered in Kansas City and
          Dick Hassur opened the first licensed restaurant in Topeka (Kansas).
          Fifteen years later, the first Pizza Hut opened in the United Kingdom
          and since then Pizza Hut became the largest pizza producing company in
          the world.
        </p>

        <p className="mb-4">
          Pizza Hut controls over 11,000 pizza restaurants and delivery points
